            ...
            <div class="col s12 flex">
                <div class="flex" style="padding: 20px 0">
                    ...
                    <div style="margin-left: 8px">
                        ...
                        При подаче объявления пожалуйста сверяйте данные объявлений, если вы хотите предложить или получить услугу или вы работаете по принципу фриланса (Заказ-оплата), подайте объявления в раздел <a spa="publish/service">Услуги</a>. В случае нарушения <a>правил подачи объявлений</a> ваше объявление будет удалено и вы получите блокировку на подачу всех объявлений, при повторных нарушениях ваш аккаунт может быть заблокирован.
                    </div>
                </div>
            </div>
            <form method="post" class="col s12">
                <div class="card-panel" style="margin-top: 0">
                    <div class="row" style="margin: 0">
                        ...
                        <div class="input-field col s12 l6">
                            <input type="text" maxlength="30" required placeholder="Должность (Например водитель)" name="tag" class="bw-text">
                        </div>
                ...
                <div class="flex" style="width: 100%;">
                    <button name="ad-publish-work" class="btn btn-large slafy-color waves-effect z-depth-s" style="width: 100%; max-width: 250px; margin: auto">Опубликовать</button>
                </div>
            </form>
        </div>
    </div>
