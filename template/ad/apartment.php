...
foreach ($imgList as $img) {
    $imgSlider .= '
        <div class="carousel-item black white-text" style="position: relative; padding-top: 56.25%;">
            <img style="border-radius: 8px !important; position: absolute; top: 0; height: 100%" alt="' . $this->ad['tag'] . ' ' . $authorInfo['login'] . '" src="' . IMAGE_CDN_PATH .'/upload/apartment/' . $authorInfo['id'] . '/' . $img . '">
        </div>
    ';
}
$imgContent = '
...
<script type="application/ld+json">
  {
    ...
    "image": [
      "<?php echo IMAGE_CDN_PATH .'/upload/apartment/' . $authorInfo['id'] . '/' . reset($imgList) ?>"
    ]
  }
</script>
        ...
        <div class="row">
            ...
            <div class="col s12 flex">
                <div>
                    ...
                    <div>
                        <a href="https://maps.google.com/maps?q=<?php echo $this->ad['latitude'] ?>,<?php echo $this->ad['longitude'] ?>&hl=en&z=15&amp;output=embed" target="_blank" class="grey-text flex"><?php echo $apartmentTypes[$this->ad['type']] . ' · ' . $this->ad['tag'] ?>
                            <span style="font-size: 1rem;padding-top: 1px;margin-left: 4px;" class="material-icons-round">launch</span>
                        </a>
                    </div>
                </div>
                <h3 class="green-text hide-on-med-and-down" style="margin-left: auto">
                    <b>$<?php echo number_format($this->ad['price']) ?></b><label>/мес</label>
                </h3>
            </div>
            <div class="col s12 flex">
                <h3 class="green-text show-on-medium-and-down" style="display: none">
                    <b>$<?php echo number_format($this->ad['price']) ?></b><label>/мес</label>
                </h3>
            </div>
            <div class="col s12">
            ...
            <div class="col s12 flex" style="margin-top: 12px">
                ...
                <form method="post" class="<?php echo $authorInfo['id'] == $userInfo['id'] ? '' : 'hide' ?>" style="margin: auto;">
                    ...
                    <button name="delete-ad-apartment" class="btn red white-text z-depth-s waves-effect animated slafy-anim">Удалить</button>
                </form>
